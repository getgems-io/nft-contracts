...
Перейдите на страницу https://getgems.io/public-api и авторизируйтесь с помощью TON Connect.
...
- Доступ к API стоит 10 GRAM в месяц и может быть оплачен сразу на один или несколько месяцев.
