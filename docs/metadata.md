...
| attributes   | NFT attributes                                                                        | A list of attributes, where a trait_type (attribute name) and value (a short description of the attribution) is specified. Please find an example below.                                                                                                                              |
